...
profile_config = ProfileConfig(  # substitua pelo nome do profile_config adequado *
    profile_name="project_02",  # substitua pelo nome do projeto (pasta do dbt)
...
my_cosmos_dag = DbtDag(
    project_config=ProjectConfig(
        f"{airflow_home}/dags/dbt/project_02",  # substitua pelo caminho do seu projeto dbt (pasta do projeto dbt)
    ),
    ...
    dag_id="simple-dag-2",  # substitua pelo nome do arquivo .py
